...
def main():
    try:
        ...
        data_url = r"/Users/bedirhancelik/Desktop/mlflow-sentiment-analysis/data/preprocessing_df.csv"
        ...
        train_data, test_data = train_test_split(final_df, test_size=test_size, random_state=114)
